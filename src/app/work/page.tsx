    ...
    <>
      <section className=" overflow-hidden h-80 relative">
        <div className=" ">
          <svg
            aria-hidden="true"
            className="absolute inset-x-0 -top-20 -z-10 h-[1000px] w-full fill-blue-50 stroke-blue-900/5 [mask-image:linear-gradient(to_bottom_left,white_40%,transparent_50%)]"
          >
            <rect
              width="100%"
              height="100%"
        ...
        <div className="justify-center max-w-5xl mx-auto items-center flex flex-col h-full">
          <h1 className="text-gray-700 font-bold text-4xl lg:text-6xl text-center ">
            A glimpse into <br /> our <span className="text-blue-500">projects</span>
          </h1>
            ...
            {Project.map((props, index) => (
              ...
              >
                ...
                <div className="flex flex-col md:flex-row gap-4">
                  <div className="border hover:shadow-xl duration-500 rounded-[8px] h-56 overflow-hidden w-full md:w-96 bg-blue-600 shadow-md">
                    <Image
                      src={props.img1}
                      width={1000}
                      height={1000}
