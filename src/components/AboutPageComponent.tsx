    ...
    <>
      <section className=" overflow-hidden h-[70vh] relative">
        ...
        <div className="-z-20 ">
          <svg
            aria-hidden="true"
            className="absolute inset-x-0 -top-20 -z-10 h-[1000px] w-full fill-blue-50 hover:fill-blue-500 stroke-blue-900/5 [mask-image:linear-gradient(to_bottom_left,white_40%,transparent_50%)]"
          >
            <rect
              width="100%"
              height="100%"
        ...
        <div className="justify-center max-w-5xl z-[10]  mx-auto items-center flex flex-col gap-4 h-full px-5">
          <Fade direction="down">
            <h1 className="text-gray-700 font-bold text-4xl lg:text-7xl text-center ">
              Welcome to <span className="text-blue-500">Noblessetech</span>
            </h1>

            
            <p className="text-base lg:text-lg font-medium text-gray-600 text-center max-w-7xl mx-auto">
              Where innovation meets diversity in the heart of India. we&apos;re the backbone of
              creativity and expertise, driven by a team of exceptional minds.
            </p>
          </Fade>
        </div>
        <div className="h-[70vh] w-full -z-10  bg-gradient-to-b from-transparent to-blue-500/[0.2] absolute top-0 left-0"></div>
      </section>
      <section className="max-w-6xl mx-auto py-10 px-5 flex flex-col  gap-5 justify-center">
        <div className=" flex flex-col gap-5">
          ...
          <Fade direction="left" >
                <p>
                  Welcome to Noblessetech, your trusted partner in digital solutions. We specialize in helping businesses of all sizes enhance their online presence and achieve their goals. With a dedicated team of experts in design, development, and marketing, we offer a comprehensive range of services tailored to meet your unique needs.
              </p><br />

              <p> Located in India with a global presence, we blend local insights with global expertise to deliver high-quality results that drive success. Whether you&apos;re launching a start up or looking to improve your existing digital strategies, we are committed to providing innovative solutions that foster growth and engagement.</p><br />
                <p> At Noblessetech, we believe in building strong relationships with our clients, ensuring you have the support you need every step of the way.</p><br />
                <p>
            ...
            <div className="flex flex-col  gap-5 justify-center ">
              ...
              <Fade direction="left" >
                    ...
                    <p>With offices in India, we bring local expertise and a global vision to your business, helping you grow both locally and internationally. Our mission is to build lasting partnerships, providing solutions that empower businesses to thrive in the digital world.
                    </p>
                    <ul className="flex flex-col gap-4 mt-4 text-base md:text-lg ">
                      <li className="flex flex-col md:flex-row text-center md:text-start gap-1 items-center"><LoaderPinwheel className="text-blue-400" /> <strong>Client-Centric Focus: </strong> <span className="ml-4">Understanding unique needs.</span></li>
                      <li className="flex flex-col md:flex-row text-center md:text-start gap-1 items-center"><Pickaxe className="text-blue-400" /> <strong>Expert Craftsmanship: </strong> <span className="ml-4">Skilled team delivering quality.</span> </li>
                      <li className="flex flex-col md:flex-row text-center md:text-start gap-1 items-center"><ArrowsUpFromLine className="text-blue-400" /> <strong>Agile Methodology: </strong> <span className="ml-4">Flexibility and adaptability.</span></li>
                      <li className="flex flex-col md:flex-row text-center md:text-start gap-1 items-center"><Pyramid className="text-blue-400" /> <strong>End-to-End Guidance: </strong> <span className="ml-4">Support from planning to maintenance.</span></li>
                      <li className="flex flex-col md:flex-row text-center md:text-start gap-1 items-center"><BetweenHorizontalStart className="text-blue-400" /> <strong>Data-Driven Strategies: </strong> <span className="ml-4">Measurable results.</span> </li>
                    </ul>
            ...
            <Fade direction="left" >
              ...
              <h2 className="text-center text-2xl font-bold text-blue-500"> Our mission is simple</h2>
            </Fade>
            <br />
            <Fade direction="left" >
        ...
        <div className="max-w-6xl mx-auto mt-6 flex flex-col gap-5">
          <Fade direction="left" >
            ...
            <h2 className=" text-2xl font-bold text-center text-blue-500">Our Story</h2>
          </Fade>

          <Fade direction="left" >

          <p>
            Based out of India, we are proud to harness the strengths of our
          ...
          <p>
            At Noblessetech, we&apos;re more than just a team; we&apos;re a dream
      ...
      <section className="py-10 ">
        <div>
          <div className="flex flex-col max-w-7xl mx-auto gap-5 justify-center items-center">
            <Fade direction="left" >
              <h1 className="text-center py-10 font-bold text-xl md:text-4xl text-blue-600">
                Why Choose Us
              </h1>
            </Fade>
