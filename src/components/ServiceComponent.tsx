    ...
    <div>
      <section className=" overflow-hidden h-96 relative pt-10">
        <div className=" ">
          <svg
            aria-hidden="true"
            className="absolute inset-x-0 -top-20 -z-10 h-[1000px] w-full fill-blue-500/[0.2] stroke-purple-900/5 [mask-image:linear-gradient(to_bottom_left,white_40%,transparent_50%)] "
          >
            <rect
              width="100%"
              height="100%"
      ...
      <section className="pb-10">
        <div className="max-w-7xl mx-auto  px-5 flex flex-col gap-4">
          <div>
            <Fade direction="left">
              <h2 className="text-3xl text-center py-5 mb-10 font-bold underline text-blue-500">
                Our Services
              </h2>
            </Fade>
